...
num_employees <- nrow(salaries[salaries$raise == TRUE, ]) 
...
highest_employee <- salaries[salaries$salary_adjustments == highest_raise, "employees"]
...
lowest_employee <- salaries[salaries$salary_adjustments == lowest_raise, "employees"]
...
loss <- mean(salaries$salary_adjustments[salaries$raise == FALSE])
...
write.csv(salaries,"Salary_Data.csv")
